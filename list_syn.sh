...
${SRCDIR}/a37_a38.StretchDecon2.sh
...
# ${SRCDIR}/b33_2.ESW_OneCate_ScS.sh
# ${SRCDIR}/b34.ClusterWaveform.sh
# ${SRCDIR}/b35_1.ESW_S_Catalog.sh
# ${SRCDIR}/b35_2.ESW_S_Profile.sh
# ${SRCDIR}/b36_1.ESW_ScS_Catalog.sh
# ${SRCDIR}/b36_2.ESW_ScS_Profile.sh
# ${SRCDIR}/b37_1.StretchWindow.sh
# ${SRCDIR}/b37_2.StretchUp.sh
# ${SRCDIR}/b37_3.TstarStretchWindow.sh
# ${SRCDIR}/b37_4.TstarStretchUp.sh
# ${SRCDIR}/b37_5.NoStretch.sh
...
# ${SRCDIR}/a57.FreqGameSyn.sh
# ${SRCDIR}/a70.IncreasedCC.sh
# ${SRCDIR}/a71.DocumentAmplitude.sh

# ${SRCDIR}/b57.FreqGameSyn.sh
# ${SRCDIR}/b70.IncreasedCC/plot.sh
# ${SRCDIR}/b71.DocumentAmplitude.sh

# ===== under construction =====
# ${SRCDIR}/a38.Ammon.sh

# ${SRCDIR}/b40_2.DeconFRS_Compare.sh
# ${SRCDIR}/b40_3.DeconFRS_CompareEQ.sh
# ${SRCDIR}/b40_4.DeconFRS_CompareMethodEQ.sh
# ${SRCDIR}/b41_2.CatalogCompareDeconMethod.sh
# ${SRCDIR}/b41_3.CatalogCompareStretchMethod.sh
