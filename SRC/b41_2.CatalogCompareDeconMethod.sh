...
do
	...
	if ! [ -d ${WORKDIR_WaterDecon}/${EQ} ] || ! [ -d ${WORKDIR_SubtractDecon}/${EQ} ] || ! [ -d ${WORKDIR_WaterHalfSDecon}/${EQ} ]
	then
...
#     REGESF="-R-50/50/-5/5"
    ...
    do
        ...
        Sesf_stretched_Raw=${WORKDIR_WaterHalfSDecon}/${EQ}/${Cate}.esf
        deconfile_Raw=${WORKDIR_WaterHalfSDecon}/${EQ}/${STNM}.trace

        frsfile_Water=${WORKDIR_WaterFRS}/${EQ}_${STNM}.frs
        frsfile_Subtract=${WORKDIR_SubtractFRS}/${EQ}_${STNM}.frs
        frsfile_Raw=${WORKDIR_WaterHalfSFRS}/${EQ}_${STNM}.frs
...
EOF
    ...
    ps2pdf tmp.ps ${WORKDIR_Plot}/${EQ}_DeconMethodCompare.pdf
