...
gmt psxy tmpfile_stlo_stla_MisfitScS_Thin ${REG} ${PROJ} -Sx -W0.7p,blue -O -K >> ${OUTFILE}
gmt psxy tmpfile_stlo_stla_MisfitScS_Fat ${REG} ${PROJ} -Sc -W0.7p,red -O -K >> ${OUTFILE}

cat > tmpfile_$$ << EOF
${XMIN} ${YMIN} ScS Misfit2 @;blue;Thin@;; @;red;Fat@;;
EOF
