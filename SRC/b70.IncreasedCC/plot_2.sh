...
#==========  y axis ==========
YMAX=0
pshistogram tmpfile_FRS -W${XINC} -IO > tmpfile_$$
...
pshistogram tmpfile_FRS ${REG} ${PROJ} -W${XINC} -L0.5p -Gblue -Ba${XNUM}f${XINC}:"${xlabel}":/a${YNUM}f${YINC}:"${ylabel}":WS -O -K >> ${OUTFILE}
