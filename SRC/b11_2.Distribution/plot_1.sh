...
do
    awk -v C=${count} '{if ($1==C && $4>0) print $2,$3,$4}' tmpfile_cate_az_Stakeoff_misfit > tmpfile1_$$
    awk -v C=${count} '{if ($1==C && $4<0) print $2,$3,-$4}' tmpfile_cate_az_Stakeoff_misfit > tmpfile2_$$
