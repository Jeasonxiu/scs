...
# EOF
    ...
    do
        ...
        psxy ${WORKDIR_Stretch}/${EQ}/tmpfile_${cate}_1_${nXStretch}.Sstretch -R -J -Wyellow -O -K >> ${OUTFILE}
        psxy ${WORKDIR_Stretch}/${EQ}/tmpfile_${cate}_${nYStretch}_1.Sstretch -R -J -Wyellow -O -K >> ${OUTFILE}
        psxy ${WORKDIR_Stretch}/${EQ}/tmpfile_${cate}_${nYStretch}_${nXStretch}.Sstretch -R -J -Wyellow -O -K >> ${OUTFILE}
