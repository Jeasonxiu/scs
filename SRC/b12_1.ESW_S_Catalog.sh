...
select stnm,concat("${WORKDIR_ESF}/${EQ}_${ReferencePhase}/",category,"/",stnm,".waveform"),netwk,gcarc,az,baz,stlo,stla,D_T_S,CCC_S,SNR_S,Weight_S,Misfit_S,Peak_S,Polarity_S,Rad_Pat_S,Norm2_S,N_T1_S,N_T2_S,S_T1_S,S_T2_S,category from Master_a12 where eq=${EQ} and wantit=1 order by category,gcarc;
EOF
