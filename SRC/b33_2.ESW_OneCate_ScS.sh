...
select evlo,evla,evde,mag from Master_a33 where eq=${EQ} limit 1;
EOF
...
select stnm,concat("${WORKDIR_ESFAll}/${EQ}_${MainPhase}/",stnm,".waveform"),netwk,gcarc,az,baz,stlo,stla,D_T_ScS_All,CCC_ScS_All,SNR_ScS_All,Weight_ScS_All,Misfit_ScS_All,Peak_ScS_All,Polarity_ScS_All,Rad_Pat_ScS,Norm2_ScS_All,N_T1_ScS_All,N_T2_ScS_All,S_T1_ScS_All,S_T2_ScS_All from Master_a33 where eq=${EQ} and wantit=1 order by gcarc;
EOF
