...
do
    ...
    do
        ...
        while read stnm
        do
            echo "${VSlow} ${stnm} ${WORKDIR_Sampling}/${EQ}_${stnm}_${ReferencePhase}.path ${WORKDIR_Sampling}/${EQ}_${stnm}_${MainPhase}.path" >> tmpfile_Cin
        done < tmpfile_stnm

        # C code.
        ${EXECDIR}/SectionLVRF.out 0 3 $((SectionNum+1)) << EOF
tmpfile_Cin
S
${EQ}
${D1}
