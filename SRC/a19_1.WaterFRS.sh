...
# Outputs:
#
#           ${WORKDIR_WaterFRS}/${EQ}_${STNM}.frs
#
# Shule Yu
# Jun 22 2014
#==============================================================
...
select concat("${WORKDIR_WaterDecon}/",EQ,"/",STNM,".trace"),concat(EQ,"_",STNM,".frs") from Master_a17 where eq=${EQ} and wantit=1;
EOF
