...
gmt psxy tmpfile_az_takeoff_MisfitScS_Thin ${REG} ${PROJ} -Sx -Wdarkblue -N -O -K >> ${OUTFILE}
gmt psxy tmpfile_az_takeoff_MisfitScS_Fat ${REG} ${PROJ} -Sc -Wdarkred -N -O -K >> ${OUTFILE}
