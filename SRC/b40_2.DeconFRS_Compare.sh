...
# (from Different Decon Dir, same syn data)
#
...
do
    ...
    Thickness=`echo "${INFO}" | awk '{printf "%.2lf",$4}'`
    ...
    ${BASHCODEDIR}/Findfield.sh ${FRSDIR1}/INFO_All "${keys}" | awk -v E=${EQ} '{if ($1==E) {$1="";print $0}}' > tmpfile_info
...
EOF
            ...
            title2="${EQ}  Vs: ${Vs_Change}  H: ${Thickness} km.  Rho: ${Rho_Change}  NSTA: ${NSTA}"
...
EOF
    ...
    ps2pdf tmp.ps ${WORKDIR_Plot}/${EQ}_Decon_FRS_Compare.pdf
