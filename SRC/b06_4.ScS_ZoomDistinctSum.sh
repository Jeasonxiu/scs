...
# =========================================================================
# Plot S Increment Sum Profile from final selection, calling dude.
#
# Shule Yu
# Mar 17 2015
# =====================================================================
...
do
	...
	echo "    ==> Plotting ${EQ} ${MainPhase} IncSum profile..."
...
EOF
    ...
    csh ${SRCDIR}/c09.profile_zoom_distinc_sum  ${INPUT} ${DISTMIN} ${DISTMAX} -100 200 ${MainPhase} T 0.5 0.5
...
for EQ in ${EQnames}
do
    cat ${WORKDIR_Plot}/tmpdir_$$/PLOTS/${EQ}*c09*T.ps >> tmp1.ps
    cat ${WORKDIR_Plot}/tmpdir_$$/PLOTS/${EQ}*c09*Tlp.ps >> tmp2.ps
done

ps2pdf tmp1.ps ${WORKDIR_Plot}/${Title%.sh}_${MainPhase}.pdf
ps2pdf tmp2.ps ${WORKDIR_Plot}/${Title%.sh}_${MainPhase}_LowPass.pdf
